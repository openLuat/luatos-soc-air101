...
function chip()
    ...
    local header_content = string.format(
        "// Auto-generated from partition/%s.csv\n" ..
        "// DO NOT EDIT MANUALLY\n" ..
        "// Generated by buildx.lua\n" ..
        "\n" ..
        "#ifndef LUAT_PARTITION_MEM_%s_H\n" ..
        "#define LUAT_PARTITION_MEM_%s_H\n" ..
        "\n" ..
        "// %s (%dKB Flash)\n" ..
        "#define LUAT_FS_SIZE                %d      // 文件系统大小 (KB)\n" ..
        "#define LUAT_SCRIPT_SIZE            %d      // 脚本大小 (KB)\n" ..
        "\n" ..
        "#endif /* LUAT_PARTITION_MEM_%s_H */\n",
        TARGET_NAME,
        TARGET_NAME, TARGET_NAME,
        TARGET_NAME, flash_size // 1024,
        flash_fs_size // 1024,
        flash_script_size // 1024,
        TARGET_NAME
    )
